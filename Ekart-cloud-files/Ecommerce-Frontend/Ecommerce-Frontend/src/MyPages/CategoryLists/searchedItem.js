...
import { getSearchval, setSearchval } from '../../Auth';
...
const SearchedItem = () => {
    ...
    const aaa = getSearchval().replace(/["]+/g, '');
    //   let finalString = dummyString.replace(/["]+/g, '')
    const s = "http://localhost:8081/items/search/" + aaa;
    axios
        .get(s)
        .then((response) => {
        ...
        <>
            ...
            <div className="container-fluid">
                    ...
                    <div className={`${styles.profile} col-3 offset-2 text-end align-self-center d-flex justify-content-end align-items-center`}>
                        <div className="btn-group">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><p className="dropdown-item" ><i className="bi bi-cart-check me-2"></i>My Orders</p></li>
                                <li>
                ...
                <div className="row bg-body-secondary">
                    <div className="col-1">
                        <h4 className="px-2 py-1 mt-2 text-white bg-success rounded-pill">"{aaa}"</h4>
                    </div>
                    {showPopup && (
                        <div style={{
